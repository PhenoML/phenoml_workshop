    ...
    entry: Bots.flatMap((botDescription): BundleEntry[] => {
      ...
      results.push({
        ...
        resource: {
          ...
          id: botIdPlaceholder,
          name: botName,
          runtimeVersion: 'vmcontext',//IMPORTANT: USE awslambda for production as per: https://www.medplum.com/docs/bots/running-bots-locally. Use vmcontext to run locally.
          sourceCode: {
